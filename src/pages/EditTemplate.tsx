                                                                            ...
                                                                            <AnimatePresence>
                                                                                {!isCollapsed && (
                                                                                    <motion.div
                                                                                        ...
                                                                                        className="overflow-hidden pt-3 border-t border-border mt-3"
                                                                                    >
                                                                                        <RichTextEditor value={h.content} onChange={(val) => { const arr = [...form.guidelinesHighlights]; arr[i] = { ...arr[i], content: val }; update("guidelinesHighlights", arr); }} placeholder="Destaque..." />
                                                                                    </motion.div>
                                                                                )}
                                                                            </AnimatePresence>
                                                                        </div>
